...
## Phase 1: Protocol Draft Stabilization
- Close remaining `1.0-draft` ambiguities.
- Keep protocol decisions coherent across spec, schema, and examples.

## Phase 2: Schema/Conformance Hardening
- Tighten machine validation where practical.
